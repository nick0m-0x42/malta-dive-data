...
Genere le 2026-09-20 par scripts/banc_hebdo.py. Chiffres lus dans data/banc/, jamais supposes.

Premier jour archive : **2026-09-17**. Jours ecoules depuis : **4**.

| source | jours | dernier | manquants depuis le debut |
|---|---|---|---|
| previsions (GFS, IFS, ICON-EU, ICON-2I, WAM, Meteo-France, GFS Wave, courants) | 4 | 2026-09-20 | aucun |
| previsions Copernicus MEDSEA (houle, courant) | 4 | 2026-09-20 | aucun |
| observations METAR Luqa (LMML) | 4 | 2026-09-20 | aucun |
| observations courants CALYPSO | 4 | 2026-09-20 | aucun |
...
## Dernier run
```
OK 2026-09-20T05:47Z · 0 probleme(s) · 1 manque(s) amont · derniere etape : fin
...
prevision italia_meteo_arpae_icon_2i   1647/4536 valeurs non vides
...
observation CALYPSO courant : 13824 lignes, 48 heures, 7993 lignes renseignees
...
```
OK 2026-09-20T05:00Z
```

## Arbitre de houle
```
Recherche d'un arbitre de houle, 2026-09-20 05:00 UTC
...
bouees cmems_obs-ins_med_phybgcwav_mynrt_na_irr : ECHEC delai, budget de 360 s depasse apres 360 s ; candidat a requeter par plateforme, pas par boite
```
