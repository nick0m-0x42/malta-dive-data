...
Genere le 2026-09-18 par scripts/banc_hebdo.py. Chiffres lus dans data/banc/, jamais supposes.

Premier jour archive : **2026-09-17**. Jours ecoules depuis : **2**.

| source | jours | dernier | manquants depuis le debut |
|---|---|---|---|
| previsions (GFS, IFS, ICON-EU, ICON-2I, WAM, Meteo-France, GFS Wave, courants) | 2 | 2026-09-18 | aucun |
| previsions Copernicus MEDSEA (houle, courant) | 2 | 2026-09-18 | aucun |
| observations METAR Luqa (LMML) | 2 | 2026-09-18 | aucun |
| observations courants CALYPSO | 2 | 2026-09-18 | aucun |
...
## Dernier run
```
OK 2026-09-18T05:48Z · 0 probleme(s) · 1 manque(s) amont · derniere etape : fin
...
observation CALYPSO courant : 13824 lignes, 48 heures, 7423 lignes renseignees
...
```
OK 2026-09-18T05:00Z
```

## Arbitre de houle
```
Recherche d'un arbitre de houle, 2026-09-18 05:00 UTC
