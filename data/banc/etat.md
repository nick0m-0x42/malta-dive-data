...
Genere le 2026-09-22 par scripts/banc_hebdo.py. Chiffres lus dans data/banc/, jamais supposes.

Premier jour archive : **2026-09-17**. Jours ecoules depuis : **6**.

| source | jours | dernier | manquants depuis le debut |
|---|---|---|---|
| previsions (GFS, IFS, ICON-EU, ICON-2I, WAM, Meteo-France, GFS Wave, courants) | 6 | 2026-09-22 | aucun |
| previsions Copernicus MEDSEA (houle, courant) | 6 | 2026-09-22 | aucun |
| observations METAR Luqa (LMML) | 6 | 2026-09-22 | aucun |
| observations courants CALYPSO | 6 | 2026-09-22 | aucun |
...
## Dernier run
```
OK 2026-09-22T09:54Z · 0 probleme(s) · 1 manque(s) amont · derniere etape : fin
prevision gfs_seamless                 4536/4536 valeurs non vides
prevision ecmwf_ifs                    4536/4536 valeurs non vides
prevision icon_eu                      3429/4536 valeurs non vides
...
-- etape recherche CALYPSO terminee a 16 s
observation CALYPSO courant : 13824 lignes, 48 heures, 7845 lignes renseignees
-- etape CALYPSO courant terminee a 18 s
...
-- etape fin terminee a 18 s
```

## Dernier run Copernicus
```
OK 2026-09-22T09:00Z
```

## Arbitre de houle
```
Recherche d'un arbitre de houle, 2026-09-22 09:00 UTC
...
plateformes : get --index-parts code 0, 4 fichier(s) : index_history.txt, index_latest.txt, index_monthly.txt, index_platform.txt
  index_platform : 5078 plateforme(s) dans le produit, colonnes : platform_code, creation_date, update_date, wmo_platform_code, data_source, institution, institution_edmo_code, parameters, last_latitude_observation, last_longitude_observation, last_date_observation
